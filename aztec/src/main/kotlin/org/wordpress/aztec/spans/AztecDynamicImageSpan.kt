...
abstract class AztecDynamicImageSpan(val context: Context, protected var imageDrawable: Drawable?) :
	DynamicDrawableSpan() {
	...
	override fun getSize(
        ...
        return if (sizeRect.width() > 0) {
            ...
            super.getSize(paint, text, start, end, metrics)
        }
	}

	private fun adjustBounds(start: Int): Rect {
